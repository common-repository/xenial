...
`xenial/assets/activation.png`

- Xenial Navigation:
`xenial/assets/Menu.png`

- Customize the Schema output
`xenial/assets/first-half.png`
`xenial/assets/second-half.png`

- Block Crawl Bots
`xenial/assets/crawl-bots.PNG`
...
`xenial/assets/SiteNavigationElements.PNG`
`xenial/assets/webStie.PNG`
`xenial/assets/totalsd.PNG`


- View your results with Google Structured Data Testing Tool
`xenial/assets/results.png`
...
1.1.10
- Added input to add custom logo to schema.
